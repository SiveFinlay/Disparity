...
% NC: stick into the document. Will be easier to edit and you'll have less stuff cluttering the manuscript file. Also will make it easier for the thesis version.
	...
	%*************************************************
	%Remember I need to come back and fix this formatting to put the tables and figures at the end
	%I've left them for the moment to make it easier to read it all together
