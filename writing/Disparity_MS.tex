...
% I want to come up with a better title; especially now that the simulations turn out to be wrong and I'm re-phrasing the introduction to avoid mentioning adaptive radiation
...
%My simulation studies are wrong: Luke Harmon said that I can't use sim.char for shape data because the vcv matrices should be based on independent traits, not the x and y coordinates of the same shape variables.
...
%This section is irrelevant now because the simulations are wrong
	...
	% I could make this shorter by putting the two figures beside each other in panels
	%\begin{figure}
	%\centering
...
\subsection{Morphological disparity in tenrecs and golden moles} 
 % Maybe put in a modified version of my results summary table here? Easy way of comparing all the disparity measures in each of the data sets
 
Figures  \ref{fig:skdorsPCA} and \ref{fig:mandsPCA} 
%again, I could put these beside each other as panels 
...
%Sum of ranges is also a significant difference but in the opposite direction: tenrecs>golden moles  
...
%Add the permuation test results of comparing tenrecs to the other families too
%Re-think the results summaries: combine them together into tables?

%************************************
%PCA figures: maybe put them together into panels to make them fit in?
...
%Again lots of this is now irrelevant because the simulations are wrong
...
%Anomalies 1: why are there differences among disparity metrics?
...
%Anomalies 2: why are there opposite patterns in the skulls and mandibles?
...
%greater differences in diet breadth? burrowing increases diversity?

% I know that I'm grasping at straws here, I still don't have a good reason why golden moles should have more variable muscle attachment sites than tenrecs
...
%No test of adaptive significance: this is important so it needs to go into the introduction
