...
\label{tab:sklat_sims} %give it a label so I can refer to it in the text
\end{table}
...
\input{tables/skvent.sim.disp}
\label{tab:skvent_sims} %give it a label so I can refer to it in the text
\end{table}
