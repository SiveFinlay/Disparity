...
\section{Results of pairwise permutation tests}
	...
	As outlined in our methods, we used pairwise permutation tests to account for the differences in sample sizes between our two Families when comparing morphological diversity.

% Permutation results
	\begin{table}[h]
	\caption{Results of the pairwise permutation tests for the full data set (31 species of tenrec compared to 12 species of golden mole). Columns are ...} 
