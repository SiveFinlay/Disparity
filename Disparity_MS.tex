...
\modulolinenumbers[1] % Line numbering
...
\affil[1]{School of Natural Sciences, Trinity College Dublin, Dublin 2, Ireland}
\affil[2]{Trinity Centre for Biodiversity Research, Trinity College Dublin, Dublin 2, Ireland}
% I know it seems daft but they'll want the full address for both
\affil[*]{Corresponding author, sfinlay@tcd.ie} % Also need tel number and fax number - stupid but true
...
Here we test whether there is evidence for significant morphological disparity in an adaptive radiation of small insectivore %they aren't insectivore mammals, they're insectivorous - insectivore implies old taxonomic groupings%
mammals.
