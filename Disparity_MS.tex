...
%If you use GitHub that makes it a lot easier as I can just clone the repo rather than you sending me millions of files!
	%Sorry, I've put them all onto the Disparity repository in my account
...
%\restylefloat{table} 	% allows you to force tables into specific places - unrecognised command in the new style
...
\keywords{disparity, morphology, geometric morphometrics, tenrecs, adaptive radiation}
...
%NC Might want to use the standard museum abbreviations - BMNH etc.
	%SF Grand, I just used NHML because I thought the BMNH was the old name
...
% NC: stick into the document. Will be easier to edit and you'll have less stuff cluttering the manuscript file. Also will make it easier for the thesis version.
	...
	%*************************************************
	%Remember I need to come back and fix this formatting
	% Also try and think of a way of showing the figures without colour or that they could be colour online only
	%**************************************
...
% NC: Or just phylogeny?
	% SF I moved the taxonomy bit up into the morphological data collection
...
% NC: I feel like some of this belongs in the analysis section...
	%SF It could do but it's not clear where to put it without making a separate analyses section for the phylogenies and I don't think that makes sense. It 
...
%*************************************************************
	%Yes I could do this for just one of the measures and then put the others into the supplemental
%********************************************************
...
\section{Discussion} % NC: I know this is rough and hard to do before the final results are in, so I haven't done too much to it. It looks a bit long already though. Same kind of rules apply as in the introduction. Should include    . Discussion is mainly meant to set your results in the context of other work. You don't need to include every little possible problem in the caveats.
